...
<head>
    ...
    function rescaleAccordingToWindowSize() {
        if(filename == null)
        {
            ...
            {
                upload_btn.innerHTML = "<img src='./mydrive-icons/icons/download.png'  class='icon v_fliped'>";
            }
            let columns = "";
        ...
        else
        {
            ...
            {
                download_btn.innerHTML = "<img src='./mydrive-icons/icons/download.png'  class='icon'>";
                copy_btn.innerHTML = "<img src='./mydrive-icons/icons/copy.png'  class='icon'>";
            }
        }
    }
    ...
    function disableDownloadAndCopyButtons() {
        ...
        { 
            ...
            document.getElementsByTagName("body")[0].innerHTML += "<div id='login'>        <h4>Hasło:</h4>        <input type='password' id='password'>        <input type='button' id='login_btn' value='Zaloguj i prześlij pliki'>    </div>";
    ...
    function load(){ 
        if(filename == null)
        {
            ...
            section.style.height = document.getElementsByTagName('html')[0].offsetHeight - document.getElementsByTagName('header')[0].offsetHeight - (document.getElementsByTagName('section')[0].offsetHeight * 0.03) + "px";
        ...
        else if (filetype == "pdf")
        {
            ...
            podglad_office.style.height = document.getElementsByTagName('html')[0].offsetHeight - document.getElementsByTagName('header')[0].offsetHeight + "px";
        }
        else 
        {
